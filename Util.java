...
public class Util {
	...
	public static List csvToList(String csv) {
	 ...
	 static String getRemainingTime(long time, long now) {
		 long diff = time - now;
	 ...
	 static String getActualTime(int hour, int minute) {
	 ...
	 static String toPersistentTime(String txt) {
	...
	static String toPersistentDate(String txt, SimpleDateFormat sdf) {
		try {
