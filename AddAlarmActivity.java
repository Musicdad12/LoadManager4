...
//		timePicker.setCurrentMinute(state.getInt("min"));
	...
	private void findViews() {
		msgEdit = findViewById(R.id.msg_et);
		soundCb = findViewById(R.id.sound_cb);
		datePicker = findViewById(R.id.datePicker);
		timePicker = findViewById(R.id.timePicker);
		fromdateText = findViewById(R.id.fromdate_tv);
		todateText = findViewById(R.id.todate_tv);
		attimeText = findViewById(R.id.attime_tv);
        vs = findViewById(R.id.view_switcher);
