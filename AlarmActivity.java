...
//	private ViewSwitcher vs;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		FloatingActionButton fab = findViewById(R.id.imageButton2);
	...
	private void findViews() {
		headingText = findViewById(R.id.heading_tv);
		rangeText = findViewById(R.id.range_tv);
//		vs = (ViewSwitcher) findViewById(R.id.view_switcher);
	...
	private String getRangeStr() {
		...
		case 0: // Daily
            //if (date==cal.get(Calendar.DATE) && month==cal.get(Calendar.MONTH) && year==cal.get(Calendar.YEAR)) return "Today";
		...
		adapter.setViewBinder(new ViewBinder() {
			...
			public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
				...
				case R.id.time_tv:
					...
					TextView tv2 = parent.findViewById(R.id.msg_tv);
...
/*		case R.id.toggleButton1:
	...
	protected void onPrepareDialog(int id, Dialog dialog) {
		...
		switch (id) {
		case R.id.menu_edit:
			EditText msgEdit = dialog.findViewById(R.id.msg_et);
			CheckBox soundCb = dialog.findViewById(R.id.sound_cb);
