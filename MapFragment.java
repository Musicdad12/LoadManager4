...
public class MapFragment extends Fragment implements OnMapReadyCallback, FuelStopDialog.FilterListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageView butFilter = rootView.findViewById(R.id.ic_filter);
    ...
    public void OpenDialog() {
        ...
        filterDialog.show(getActivity().getSupportFragmentManager(), "Map Filter Settings");
    }
    ...
    public String loadJSONFromAsset() {
        String json;
        try {
            InputStream is = context.getAssets().open("FuelStops.json");
