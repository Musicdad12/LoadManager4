...
public class zDetailsFragment extends Fragment {

    // Create a DetailsFragment that contains the hero data for the correct index
    public static zDetailsFragment newInstance(int index) {
        zDetailsFragment f = new zDetailsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //text.setText(ORY[getShownIndex()]);
        return scroller;
    }
}