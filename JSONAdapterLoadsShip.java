...
class JSONAdapterLoadsShip extends BaseAdapter implements ListAdapter {

    private final Activity activity;
    private final JSONArray jsonArray;

    JSONAdapterLoadsShip(Activity activity, JSONArray jsonArray) {
    ...
    @Override public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null)
            convertView = activity.getLayoutInflater().inflate(R.layout.listview_loads_ship_layout, null);
